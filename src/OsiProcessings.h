...
namespace osiris
{
    ...
    */
    ...
    private :
        ...
        */
        void findContour ( const IplImage * pSrc , CvPoint  rCenter , const std::vector<float> & rTheta , int minRadius , int maxRadius ,std::vector<CvPoint>&,
						int scale,const IplImage * pMask = 0 ) ;
