...
namespace osiris
{
    ...
    */
    ...
    public :
        int extractFeature(std::string& rFileName,std::vector<int> &shift,std::vector<std::string>& vFeature);
        /** Default constructor.
        ...
        */
        ...
        //cjf
				void showConf();
        std::map<std::string,std::string> mOtherConf ;
    private :
        // by cjf
				std::vector<int>  mAppPnts_x;
				std::vector<int>  mAppPnts_y;
        // Commands
        ...
        */
        ...
        //cjf
				/*参数
          rFileName:文件名,shift偏移的像素大小，vFeature对每个shift提取的特征。
			  */
